# Generated by Django 3.1 on 2022-02-27 03:39
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(
                    max_length=100, verbose_name='District')),
                ('city', models.CharField(max_length=100, verbose_name='City')),
                ('description', models.TextField(
                    blank=True, verbose_name='Description')),
                ('price', models.DecimalField(decimal_places=5,
                 max_digits=15, verbose_name='Price')),
                ('purchaseType', models.CharField(default='Buy',
                 max_length=8, verbose_name='PurchaseType')),
                ('propertyType', models.CharField(default='House',
                 max_length=15, verbose_name='PropertyType')),
                ('bedroom', models.IntegerField(blank=True,
                 default=None, null=True, verbose_name='Bedroom')),
                ('bathroom', models.IntegerField(blank=True,
                 default=None, null=True, verbose_name='Bathroom')),
                ('garage', models.IntegerField(blank=True,
                 default=None, null=True, verbose_name='Garage')),
                ('sqft', models.IntegerField(blank=True,
                 default=None, null=True, verbose_name='Sqft')),
                ('photo_main', models.ImageField(blank=True, default=None, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scrapertitle', models.CharField(
                    max_length=100, verbose_name='ScraperTitle')),
                ('scraper_location', models.CharField(
                    max_length=100, verbose_name='ScraperLocation')),
                ('scraper_price', models.CharField(
                    max_length=100, verbose_name='ScraperPrice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='appartment_listing.listings')),
            ],
            options={
                'verbose_name': 'Photo',
